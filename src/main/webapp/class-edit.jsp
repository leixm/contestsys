	...
	<div class="layui-fluid">
		<div class="layui-row">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					<label for="teacher" class="layui-form-label"> <span
						class="x-red">*</span>任课教师
					</label>
					<div class="layui-input-inline">
						<select id="teacher" name="teacher" class="valid"
							lay-filter="class">
							<option value="null">请选择任课教师</option>

							<c:forEach var="obj" items="${teachers}" varStatus="s">
								<option value="${obj.userId}"
									<c:if test='${obj.userId==classes.teacher}'> selected='selected'</c:if>>${obj.realname}</option>
